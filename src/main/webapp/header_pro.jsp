    ...
    <div class="navbar navbar navbar-default">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand" href="/store/view_customers">View Customers</a>
            ...
            <div class="navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class=""><a href="/store/add_product">Add Product</a></li>
                    <li class=""><a href="/store/view_products">View Products</a></li>
                </ul>
            </div>
        </div>
    </div>
