...
(/** @lends <global> */function( $ ) {
	...
	function _fnColumnOptions( oSettings, iCol, oOptions )
	{
		...
		/* Check that the class store is correct for sorting */
	...
	DataTable.models.oColumn = {
		...
		/**
		 * Store for manual type store using the `column.type` option. This
	...
	DataTable.ext = _ext = {
		 ...
		 * detection or by direct store using the `type` option for the column.
